        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            ...
            <form>
              ...
              <div class="row">
                ...
                <div class="form-group col-md-6">
                  ...
                  value="{{ $admins->first_name }}" placeholder="Enter First Name of Admin">
                </div>

                <div class="form-group col-md-6">
                  <label for="last_name">Last Name of Admin</label>
                  <input type="text" class="form-control" id="last_name" name="last_name"
                  value="{{ $admins->last_name }}" placeholder="Enter Last Name of Admin">
                </div>
              </div>
            ...
            <div class="row">
                ...
                <div class="form-group col-md-6">
                  ...
                  value="{{ $admins->mobile }}" placeholder="Mobile of Admin">
                </div>

                <div class="form-group col-md-6">
                  <label for="address">address of Admin</label>
                  <input type="text" class="form-control" id="address" name="address"
                  value="{{ $admins->address }}" placeholder="Enter address of Admin">
                </div>
              </div>
            <div class="row">
          ...
          <div class="form-group col-md-6">
              ...
              <div class="row">
                  ...
                  value="{{ $admins->date }}" placeholder="Enter Date of Admin">
                </div>
