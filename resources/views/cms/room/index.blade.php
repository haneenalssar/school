                  ...
                  <div class="card-header">
                      ...
                      <form action="" method="get" style="margin-bottom:2%;">
                          ...
                          <div class="col-md-4">
                                ...
                                <a href="{{route('rooms.create')}}"><button type="button" class="btn btn-md btn-primary">   Add new room </button></a>
                                {{-- @endcan --}}
                          </div>
                ...
                <tr>
                  ...
                  <td>
                    <div class="btn-group">
                      ...
                      <a href="{{route('grades.edit',$room->id)}}" class="btn btn-info" title="Edit">
                        Edit
                        </a>
